            ...
            <div class="right col c-10">
                ...
                <h3 class="header-name">Bài hát</h3>
                    ...
                    <div class="libarary-img--animaiton">
                                    <li class="libarary-img--animaiton-item second" style="background-image: url(../../public/images/singers/chuBin.jpg)">

                                    </li>
                                    <li class="libarary-img--animaiton-item third" style="background-image: url(../../public/images/singers/chuBin.jpg)">
                                        
                                    </li>
                                    <li class="libarary-img--animaiton-item first" style="background-image: url(../../public/images/singers/chuBin.jpg)">
